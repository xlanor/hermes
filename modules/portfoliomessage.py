...
class Pmessage():
	def pmsg(self,address,username,ethplorerscan):
		msg = "🏠ETH Address: <b>"+address+"</b> "
		msg += "📋Generated by "+username+" at "
		...
		msg += "\n Your total portfolio value in 🇸🇬SGD is $"+str(sgdtotal)
		msg += "\n Your total portfolio value in 🇺🇸USD is $"+str(usdtotal)
		...
		msg += "\n<i>** CVC,CND and MTH are removed because their values could not be retrieved</i>"
		return msg